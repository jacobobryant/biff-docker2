...
(defn notify-clients [{:keys [com.biffweb.examples.docker/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.biffweb.examples.docker/chat-clients] :as ctx}]
  {:status 101
